...
var HeaderRowContainerComp = ({ pinned }) => {
  ...
  return /* @__PURE__ */ import_react11.default.createElement(import_react11.default.Fragment, null, pinnedLeft && /* @__PURE__ */ import_react11.default.createElement(
    ...
    insertRowsJsx()
  ), centre && /* @__PURE__ */ import_react11.default.createElement("div", { ref: setRef2, className: "ag-header-viewport " + className, role: "presentation", tabIndex: -1 }, /* @__PURE__ */ import_react11.default.createElement("div", { ref: eCenterContainer, className: "ag-header-container", role: "rowgroup" }, insertRowsJsx())));
};
...
var GridHeaderComp = () => {
  ...
  const setRef2 = (0, import_react12.useCallback)((eRef) => {
    eGui.current = eRef;
    gridCtrlRef.current = eRef ? context.createBean(new import_ag_grid_community12.GridHeaderCtrl()) : context.destroyBean(gridCtrlRef.current);
    if (!eRef)
      return;
    const compProxy = {
      addOrRemoveCssClass: (name, on) => setCssClasses((prev) => prev.setClass(name, on)),
...
var PopupEditorComp = (props) => {
  ...
  useEffectOnce(() => {
    ...
    const translate = (0, import_ag_grid_community14._getLocaleTextFunc)(localeSvc);
  ...
  (0, import_react15.useLayoutEffect)(() => {
    return () => {
      if (cellCtrl.isCellFocused() && popupEditorWrapper?.getGui().contains((0, import_ag_grid_community14._getActiveDomElement)(beans))) {
...
var CellComp = ({
  ...
  const beans = (0, import_react17.useContext)(BeansContext);
  const { context } = beans;
  ...
  const eWrapper = (0, import_react17.useRef)(null);
      ...
      const addComp = (comp) => {
        if (comp) {
          ...
          cellWrapperDestroyFuncs.current.push(() => {
            context.destroyBean(comp);
            (0, import_ag_grid_community15._removeFromParent)(eGui2);
          });
        }
        return comp;
      };
  ...
  const init = (0, import_react17.useCallback)(() => {
  ...
  const setGuiRef = (0, import_react17.useCallback)((ref) => {
    eGui.current = ref;
    init();
  }, []);
  const setWrapperRef = (0, import_react17.useCallback)((ref) => {
  ...
  const renderCell = () => /* @__PURE__ */ import_react17.default.createElement("div", { ref: setGuiRef, style: userStyles, role: cellAriaRole, "col-id": colIdSanitised }, showCellWrapper ? /* @__PURE__ */ import_react17.default.createElement("div", { className: "ag-cell-wrapper", role: "presentation", ref: setCellWrapperRef }, showContents()) : showContents());
  if (cellCtrl.isCellSpanning()) {
    return /* @__PURE__ */ import_react17.default.createElement("div", { ref: setWrapperRef, className: "ag-spanned-cell-wrapper", role: "presentation" }, renderCell());
  }
  return renderCell();
};
...
var RowContainerComp = ({ name }) => {
  ...
  const containerOptions = (0, import_react19.useMemo)(() => (0, import_ag_grid_community17._getRowContainerOptions)(name), [name]);
  ...
  const viewportClasses = (0, import_react19.useMemo)(() => classesList("ag-viewport", (0, import_ag_grid_community17._getRowViewportClass)(name)), [name]);
  const containerClasses = (0, import_react19.useMemo)(() => classesList((0, import_ag_grid_community17._getRowContainerClass)(name)), [name]);
  const spanClasses = (0, import_react19.useMemo)(() => classesList("ag-spanning-container", (0, import_ag_grid_community17._getRowSpanContainerClass)(name)), [name]);
  ...
  const setRef2 = (0, import_react19.useCallback)(() => {
    ...
    if (areElementsReady()) {
      ...
      rowContainerCtrlRef.current = context.createBean(new import_ag_grid_community17.RowContainerCtrl(name));
  ...
  const buildSpanContainer = () => isSpanning && /* @__PURE__ */ import_react19.default.createElement("div", { className: spanClasses, ref: setSpanContainerRef, role: "rowgroup" }, spannedRowCtrlsOrdered.map((rowCtrl) => /* @__PURE__ */ import_react19.default.createElement(rowComp_default, { rowCtrl, containerType: containerOptions.type, key: rowCtrl.instanceId })));
  return /* @__PURE__ */ import_react19.default.createElement("div", { className: viewportClasses, ref: setViewportRef, role: "presentation" }, buildContainer(), buildSpanContainer());
};
...
var GridBodyComp = () => {
  ...
  if (!cssClassManager.current) {
    cssClassManager.current = new import_ag_grid_community18.CssClassManager(() => eRoot.current);
  }
  ...
  const setRef2 = (0, import_react20.useCallback)((eRef) => {
    ...
    addComp(eRef, import_ag_grid_community18.FakeHScrollComp, " AG Fake Horizontal Scroll ");
    const overlayComp = overlays?.getOverlayWrapperCompClass();
    if (overlayComp) {
      addComp(eRef, overlayComp, " AG Overlay Wrapper ");
    }
    if (eBody.current) {
      addComp(eBody.current, import_ag_grid_community18.FakeVScrollComp, " AG Fake Vertical Scroll ");
    }
    const compProxy = {
      setRowAnimationCssOnBodyViewport: setRowAnimationClass,
      setColumnCount: (count) => {
        if (eRoot.current) {
          (0, import_ag_grid_community18._setAriaColCount)(eRoot.current, count);
        }
      },
      setRowCount: (count) => {
        if (eRoot.current) {
          (0, import_ag_grid_community18._setAriaRowCount)(eRoot.current, count);
        }
      },
      setTopHeight,
      setBottomHeight,
      ...
      registerBodyViewportResizeListener: (listener) => {
        if (eBodyViewport.current) {
          const unsubscribeFromResize = (0, import_ag_grid_community18._observeResize)(beans, eBodyViewport.current, listener);
    ...
    const ctrl = context.createBean(new import_ag_grid_community18.GridBodyCtrl());
...
var GridComp = ({ context }) => {
  ...
  const setRef2 = (0, import_react22.useCallback)((eRef) => {
    ...
    gridCtrlRef.current = eRef ? context.createBean(new import_ag_grid_community20.GridCtrl()) : context.destroyBean(gridCtrlRef.current);
  ...
  const isFocusable = (0, import_react22.useCallback)(() => !gridCtrlRef.current?.isFocusable(), []);
...
var RenderStatusService = class extends import_ag_grid_community21.BeanStub {
  wireBeans(beans) {
...
var AgGridReactUi = (props) => {
  ...
  const setRef2 = (0, import_react23.useCallback)((eRef) => {
    ...
    const mergedGridOps = (0, import_ag_grid_community22._combineAttributesAndGridOptions)(
      props.gridOptions,
      props,
    ...
    const gridParams = {
      providedBeanInstances: {
        frameworkCompWrapper: new ReactFrameworkComponentWrapper(
          ...
          mergedGridOps.reactiveCustomComponents ?? (0, import_ag_grid_community22._getGlobalGridOption)("reactiveCustomComponents") ?? true
        ),
        renderStatus
      },
      modules,
    ...
    const gridCoreCreator = new import_ag_grid_community22.GridCoreCreator();
  ...
  (0, import_react23.useEffect)(() => {
    ...
    processWhenReady(() => {
      if (apiRef.current) {
        (0, import_ag_grid_community22._processOnChange)(changes, apiRef.current);
      }
    });
  }, [props]);
...
var ReactFrameworkComponentWrapper = class extends import_ag_grid_community22.BaseComponentWrapper {
...
var DetailCellRenderer = (0, import_react23.forwardRef)((props, ref) => {
  ...
  const parentModules = (0, import_react23.useMemo)(
    () => (0, import_ag_grid_community22._getGridRegisteredModules)(props.api.getGridId(), detailGridOptions?.rowModelType ?? "clientSide"),
    [props]
  );
  ...
  if (props.template) {
    (0, import_ag_grid_community22._warn)(230);
  }
  const setRef2 = (0, import_react23.useCallback)((eRef) => {
    ...
    if (gos.get("detailRowAutoHeight")) {
      const checkRowSizeFunc = () => {
        ...
        if (clientHeight != null && clientHeight > 0) {
          const updateRowHeightFunc = () => {
            ...
            if ((0, import_ag_grid_community22._isClientSideRowModel)(gos, rowModel) || (0, import_ag_grid_community22._isServerSideRowModel)(gos, rowModel)) {
      ...
      resizeObserverDestroyFunc.current = (0, import_ag_grid_community22._observeResize)(beans, eRef, checkRowSizeFunc);
      checkRowSizeFunc();
    }
  }, []);
...
var ReactFrameworkOverrides = class extends import_ag_grid_community22.VanillaFrameworkOverrides {
